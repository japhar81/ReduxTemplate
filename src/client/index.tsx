...
const preloadedState: IAppState = (window as any).__PRELOADED_STATE__;
const history: any = createBrowserHistory();
const store: Store<IAppState> = configureStore(preloadedState, history);
...
let render = () => {
    const App: Component<any> = require('../client/components/counter').default;
    ReactDOM.render(
...
if (isDev) {
    if ((module as any).hot) {
        ...
        (module as any).hot.accept('../client/components/counter', () => {
            setTimeout(render);
        });
    }
}
